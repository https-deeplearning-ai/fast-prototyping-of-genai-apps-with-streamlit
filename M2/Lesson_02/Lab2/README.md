...
3. In the "Find Packages" text box, enter the following Python packages:
   ...
   - `pandas`
   - `snowflake-ml-python`
   If you're seeing an error due to library dependency error, then copy the contents of [environment.yml](environment.yml) and paste it into the `environment.yml` file in Snowsight.
