...
| File | Video Title |
|------|-------------|
| [M2L1V3.sql](M2L1V3.sql) | Snowsight Development Environment |
| [M2L1V4.ipynb](M2L1V4.ipynb) | From CSV to Cloud – Using Notebooks to Ingest Avalanche Data |
| [M2L1V5.ipynb](M2L1V5.ipynb) | Uploading a Batch of Files |
| [M2L1V6.ipynb](M2L1V6.ipynb) | From Stage to Table with Cortex |
| [M2L1V7.ipynb](M2L1V7.ipynb) | Extracting Information from the Content |
