...
- After watching the *Snowsight Development Environment* video lesson on Coursera, make sure to run the contents of [M2L1V3.sql](https://github.com/dataprofessor/fast-prototyping-of-genai-apps-with-streamlit/blob/main/M2/Lesson_01/M2L1V3.sql) in a SQL worksheet in your Snowflake Snowsight workspace. This would allow you to create the `avalanche_db` database and `avalanche_schema` schema, which you'll need for running the next lesson.
